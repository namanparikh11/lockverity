...
2. **What can I demo today?** Every v0.5–v1.8 surface in
...
comparison workflow.** A coherent lifecycle
...
- Private GitHub repository analysis (v1.8 is public-only;
