...
The AppShell sidebar shows the same version (e.g. `v2.1.0`).
...
Open `http://127.0.0.1:5173/about`. The page lists the v2.1.0
milestone, the Part A brand assets, the Part B1 single-port
runtime, the Part B2 cross-platform CLI, the Part B3A Windows
portable, and the Part B3B Windows installer. It also includes
the bounded "What v2.1.0 does not include" section. The defensive
